...
class ComicsTableSeeder extends Seeder {
    ...
    public function run(): void {
        foreach ($this->datiComics as $comic) {
            //aggiungo un'istanza per ogni elemento dell'array
            $comicModel = new \App\Models\Comic();

            $comicModel->title = $comic["title"];
            $comicModel->description = $comic["description"];
            $comicModel->thumb = $comic["thumb"];
            // devo modificare la visualizzazione del dato price perchè
            // contiene anche un carattere che non è un numero decimale
            ...
            // devo convertire array di array in json per gli artisti
